...
function CustomCursor({ enabled = true }) {
    ...
    const [zoomScale, setZoomScale] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Manipal__CLG$2f$Project$2f$Antigravity$2f$Portfolio$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(1);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Manipal__CLG$2f$Project$2f$Antigravity$2f$Portfolio$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CustomCursor.useEffect": ()=>{
            const updateZoom = {
                "CustomCursor.useEffect.updateZoom": ()=>{
            ...
            updateZoom();
            return ({
                "CustomCursor.useEffect": ()=>window.removeEventListener("resize", updateZoom)
            })["CustomCursor.useEffect"];
        }
    }["CustomCursor.useEffect"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Manipal__CLG$2f$Project$2f$Antigravity$2f$Portfolio$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
...
_s(CustomCursor, "zlOG1uY5lzGE0cECWCWKlk9tA3A=", false, function() {
    return [
...
"[project]/Desktop/Manipal CLG/Project/Antigravity/Portfolio/src/components/ui/Spotlight.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useMousePosition() {
    _s();
    const [mousePosition, setMousePosition] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Manipal__CLG$2f$Project$2f$Antigravity$2f$Portfolio$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        x: 0,
        y: 0
    });
    const updateMousePosition = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Manipal__CLG$2f$Project$2f$Antigravity$2f$Portfolio$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useMousePosition.useCallback[updateMousePosition]": (ev)=>{
            requestAnimationFrame({
                "useMousePosition.useCallback[updateMousePosition]": ()=>{
                    setMousePosition({
                        x: ev.clientX,
                        y: ev.clientY
                    });
...
function Spotlight() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Manipal__CLG$2f$Project$2f$Antigravity$2f$Portfolio$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        fileName: "[project]/Desktop/Manipal CLG/Project/Antigravity/Portfolio/src/components/ui/Spotlight.tsx",
        lineNumber: 29,
        columnNumber: 5
    }, this);
}
_s1(Spotlight, "4+pdVHF2nF+z7khGQBj5Dl56AUY=", false, function() {
    return [
        useMousePosition
    ];
});
...
//# sourceMappingURL=Desktop_Manipal%20CLG_Project_Antigravity_Portfolio_src_components_ui_dadbbf80._.js.map